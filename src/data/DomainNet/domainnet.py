...
def create_trvalte_splits(args):
    ...
    base_path = '/home/qid/UCDR2024-main/UCDR20241/src/data/'
    
    tr_classes = np.load(os.path.join(base_path, 'DomainNet', 'train_classes.npy')).tolist()
    va_classes = np.load(os.path.join(base_path, 'DomainNet', 'val_classes.npy')).tolist()
    te_classes = np.load(os.path.join(base_path, 'DomainNet', 'test_classes.npy')).tolist()
    all_domains = []
